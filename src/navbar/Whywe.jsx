...
const Whywe = () => {
  ...
  const features = [
    ...
    },
    {
      ...
      title: "Instant Funding in Minutes",
      description:
        "Get access to your funds within minutes of approval, ensuring a seamless, hassle-free, and fast borrowing experience whenever you need it!",
    },
    {
      icon: faHeadset,
