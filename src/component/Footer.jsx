            ...
            <Grid container spacing={3} alignItems="center">
              ...
              >
                <img
                  src={logo}
                  alt="Logo"
                  style={{ width: "60%", height: "auto", mb: 5 }}
                />
                <Box display="flex" gap={2} justifyContent="center" mt={5}>
                  {" "}
                  {/* Social Media Icons */}
                  <Link
                    href="https://www.facebook.com/profile.php?id=61570006966590"
                  ...
                  <Link
                    href="https://www.linkedin.com/company/qualoan/about/?viewAsMember=true"
                    target="_blank"
                  ...
                  <Link
                    href="https://www.instagram.com/qualoan/"
                    target="_blank"
                  ...
                  <Link
                    href="https://www.youtube.com/channel/UCH4UYltubKJPkE4RkrE3cjA"
                    target="_blank"
              ...
              >
                ...
                <Grid item xs={12} sm={4} sx={{ paddingTop: "12px" }}>
                  ...
                  >
                    ...
                    <li>
                      <Link href="loanRepayment" sx={linkStyle}>
                        Repay Now
                      </Link>
                    </li>
                    <li>
