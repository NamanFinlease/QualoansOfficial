  ...
  return (
    ...
    >
      ...
      <Box sx={{ flex: "1", textAlign: { xs: "center", sm: "left" } }}>
        <Typography variant="h4" fontWeight="bold" color="#fc8403" gutterBottom>
          Why Us?
        </Typography>
        <Typography
          variant="body1"
        ...
        >
          Discover the reasons why customers trust us with their financial
          needs. Our commitment to transparency, security, and convenience
          ensures a comforting experience for all.
        </Typography>
        {/* Scroll Buttons */}
        <Box
          sx={{
