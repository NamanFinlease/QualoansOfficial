...
const AboutUs = () => {
  ...
  return (
    ...
    >
      ...
      >
        Welcome to QUA Loan, your trusted partner in personal finance solutions.
        As a premier digital lending platform under Naman Finlease Private
        Limited, we specialize in providing fast, convenient, and short-term
        unsecured personal loans to salaried individuals across India. Our
        mission is to make our customers feel empowered with full access to
        credit, simplifying the loan process through the use of innovative
      ...
      >
        At QUA Loan, we understand that life can be unpredictable when it comes
        to the medical emergencies. There comes other sets of expenditures such
        as wedding expenses, home improvements, etc. So to cater to every need
        of an individual, we’re here to ensure that financial hurdles don’t hold
        you back. With our fully digital platform services, you can apply for a
        loan in minutes, track your application status in real-time and receive
      ...
      >
        ...
        >
          ...
          >
            Our mission is to make personal loans quicker, simpler, and easily
            accessible for salaried individuals. We believe in empowering people
            on financial grounds and are committed to providing easy and
            affordable access to credit. Through our partnership with Naman
            Finlease Private Limited, an RBI-registered NBFC (Non-Banking
            Financial Company), we offer loans that are secure, transparent, and
            designed as to meet the needs of today’s modern consumer.
          </Typography>
        </Box>
      ...
      >
        ...
        >
          ...
          >
            Our vision at QUA Loan is to redefine how personal loans are
            accessed by salaried professionals in India. We aim to create a
            transparent, customer-centric lending ecosystem that provides access
            to credit when it’s needed the most. By making use of innovative
            technologies and leveraging our expertise in providing financial
            services, we strive to build a future where financial inclusion is a
            reality for all, regardless of their source of income or financial
            background.
          </Typography>
        </Box>
      </Box>
      ...
      >
        ...
        >
          ...
          >
            QUA Loan is powered by a digital platform that simplifies every step
            of the loan process. We use advanced algorithms to assess your
            creditworthiness quickly and accurately, ensuring that you get the
            best possible loan offers.
          </Typography>
          ...
          >
            ...
            >
              <div>
                <Box
                  sx={{ width: "100%", borderTop: "2px solid #D9D9D9 ", my: 2 }}
                />
              ...
              <Box
                sx={{ width: "100%", borderBottom: "2px solid #D9D9D9", my: 2 }}
              />
            </Paper>
          </Box>
        </Box>
...
const techItems = [
  {
    title: " Quick Credit Assessments",
    description:
      "Our advanced algorithms ensure quick and accurate credit assessments, enabling you to get the best loan offers without any delay.",
  },
  {
    title: " User-Friendly Interface",
    description:
      "QUA Loan offers an intuitive and easy-to-navigate platform, ensuring a smooth loan application process for all users.",
  },
  {
    title: " Real-Time Tracking",
    description:
      "Track your loan application status in real-time, providing complete transparency and peace of mind throughout the process.",
  },
  {
    title: " Secure Transactions",
    description:
      "We prioritize your security by using encrypted transactions, ensuring your sensitive data remains safe at all times.",
  },
];
